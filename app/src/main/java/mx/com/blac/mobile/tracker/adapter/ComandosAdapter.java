...
public class ComandosAdapter extends BaseAdapter {
    ...
    protected ArrayList<Comando> items;
    Comando comando;
    static SharedPreferences sharedpreferences;
    private static final String PREFS_NAME = "mx.com.blac.mobile.track.pref";
    Typeface typeface,typeface1;
    ViewHolder holder=new ViewHolder();
    String TAG="NegociosAdapter";

    public ComandosAdapter(Activity activity, ArrayList<Comando> items) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_comandos, null);
...
/*
        ...
        holder.lblNombre.setText(comando.getEventoNombre());
